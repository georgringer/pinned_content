...
namespace GeorgRinger\FavoriteContent\Xclass;
...
class XclassedNewContentElementController extends NewContentElementController
{

    /**
     * Renders the wizard
     */
    protected function __wizardAction(ServerRequestInterface $request): ResponseInterface
    {
